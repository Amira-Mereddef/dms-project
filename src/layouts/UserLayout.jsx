    ...
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: 'system-ui, sans-serif', background: mainBg }}>
      ...
      <aside style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '40px', padding: '0 8px' }}>
          ...
          <div>
            <div style={{ fontSize: '15px', fontWeight: '700', color: textPri }}>My Portal</div>
            <div style={{ fontSize: '12px', color: textMuted }}>Document Management</div>
          </div>
        </div>
        ...
        <nav style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '2px' }}>
          ...
          <NavLink to="/user/documents" style={({ isActive }) => ({
